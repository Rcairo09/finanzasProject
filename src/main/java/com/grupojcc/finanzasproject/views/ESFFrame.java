...
public class ESFFrame extends javax.swing.JInternalFrame {
    ...
    public void lectura(){
        ...
        for(int i =0; i<ba.tamaño();i++){
            ...
            fondoOportunidadesTxt.setText(Double.toString(ba.obtener(i).getFondoOportunidades()));
            BancosTxt.setText(Double.toString(ba.obtener(i).getBancos()));
            inversionesTemporalesTxt.setText(Double.toString(ba.obtener(i).getInversionesTemporales()));
            totalActivosDisponibles.setText(Double.toString(ba.obtener(i).getTotalActivosDisponibles()));
            ClientesTxt.setText(Double.toString(ba.obtener(i).getClientes()));
            documentosPorCobrarTxt.setText(Double.toString(ba.obtener(i).getDocumentosPorCobrar()));
            deudoresDiversosTxt.setText(Double.toString(ba.obtener(i).getDeudoresDiversos()));
            funcionariosTxt.setText(Double.toString(ba.obtener(i).getFuncionariosYEmpleados()));
            IvaAcreditableTxt.setText(Double.toString(ba.obtener(i).getIvaAcreditable()));
            inventariosTxt.setText(Double.toString(ba.obtener(i).getInventarios()));
            anticipoProveedoresTxt.setText(Double.toString(ba.obtener(i).getAnticipoProveedores()));
            totalActivosRealizablesTxt.setText(Double.toString(ba.obtener(i).getTotalActivosRealizables()));
            totalActivosCirculantesTxt.setText(Double.toString(ba.obtener(i).getTotalActivosCirculantes()));
            terrenosTxt.setText(Double.toString(ba.obtener(i).getTerrenos()));
            edificiosTxt.setText(Double.toString(ba.obtener(i).getEdificios()));
            maquinariasTxt.setText(Double.toString(ba.obtener(i).getMaquinarias()));
            mobiliarioYEquipoTxt.setText(Double.toString(ba.obtener(i).getMobiliarioYEquipo()));
            mueblesYEnseresTxt.setText(Double.toString(ba.obtener(i).getMueblesYEnseres()));
            equipoTransporteTxt.setText(Double.toString(ba.obtener(i).getEquipoTransporte()));
            entregaYRepartoTxt.setText(Double.toString(ba.obtener(i).getEquipoEntregaYReparto()));
            totalActivosFijosTxt.setText(Double.toString(ba.obtener(i).getTotalActivosFijos()));
            derechosAutorTxt.setText(Double.toString(ba.obtener(i).getDerechosAutor()));
            patentesTxt.setText(Double.toString(ba.obtener(i).getPatentes()));
            marcasRegistradasTxt.setText(Double.toString(ba.obtener(i).getMarcasRegistradas()));
            nombresComercialesTxt.setText(Double.toString(ba.obtener(i).getNombresComerciales()));
            creditoComercialTxt.setText(Double.toString(ba.obtener(i).getCreditoComercial()));
            gastosConstitucionTxt.setText(Double.toString(ba.obtener(i).getGastosConstitucion()));
            gastosOrganizacionTxt.setText(Double.toString(ba.obtener(i).getGastosOrganizacion()));
            gastosInstalacionTxt.setText(Double.toString(ba.obtener(i).getGastosInstalacion()));
            papeleriaUtilesTxt.setText(Double.toString(ba.obtener(i).getPapeleriaYUtiles()));
            propagandaPublicidadTxt.setText(Double.toString(ba.obtener(i).getPropagandaYPublicidad()));
            primasTxt.setText(Double.toString(ba.obtener(i).getPrimasYSeguros()));
            rentasAnticipoTxt.setText(Double.toString(ba.obtener(i).getRentasAnticipo()));
            impuestosPagadosAnticipo.setText(Double.toString(ba.obtener(i).getImpuestosAnticipo()));
            totalActivosDiferibles.setText(Double.toString(ba.obtener(i).getTotalActivosDiferibles()));
            fondoAmortizacionTxt.setText(Double.toString(ba.obtener(i).getFondoAmortizacion()));
            depositoGarantiaTxt.setText(Double.toString(ba.obtener(i).getDepositoEnGarantia()));
            inversionesProcesoTxt.setText(Double.toString(ba.obtener(i).getInversionesEnProceso()));
            terrenosNoUtilizadosTxt.setText(Double.toString(ba.obtener(i).getTerrenosNoUtilizados()));
            maquinariaNoUtilizadaTxt.setText(Double.toString(ba.obtener(i).getMaquinariaNoUtilizada()));
            totalOtrosActivos.setText(Double.toString(ba.obtener(i).getTotalOtrosActivos()));
            totalActivosNoCirculantesTxt.setText(Double.toString(ba.obtener(i).getTotalActivosNoCirculantes()));
            totalActivos.setText(Double.toString(ba.obtener(i).getTotalActivos()));
            proveedoresTxt.setText(Double.toString(ba.obtener(i).getProveedores()));
            documentosPorPagarTxt.setText(Double.toString(ba.obtener(i).getDocumentosPorPagar()));
            acreedoresDiversosTxt.setText(Double.toString(ba.obtener(i).getAcreedoresDiversos()));
            dividendosTxt.setText(Double.toString(ba.obtener(i).getDividendosPorPagar()));
            ivaPorPagarTxt.setText(Double.toString(ba.obtener(i).getIvaPorPagar()));
            impuestosRentaTxt.setText(Double.toString(ba.obtener(i).getImpuestosSobreRenta()));
            InteresesTxt.setText(Double.toString(ba.obtener(i).getInteresesPorPagar()));
            sueldosPorPagarTxt.setText(Double.toString(ba.obtener(i).getSueldosPorPagar()));
            gastosPorPagarTxt.setText(Double.toString(ba.obtener(i).getGastosPorPagar()));
            totalPasivoCirculanteTxt.setText(Double.toString(ba.obtener(i).getTotalPasivosCirculantes()));
            acreedoresHipotecariosTxt.setText(Double.toString(ba.obtener(i).getAcreedoresHipotecarios()));
            documentosPorPagarLpTxt.setText(Double.toString(ba.obtener(i).getDocumentosPorPagarLP()));
            obligacionesTxt.setText(Double.toString(ba.obtener(i).getObligacionesACirculacion()));
            bonosPorPagarTxt.setText(Double.toString(ba.obtener(i).getBonosPorPagar()));
            rentasAnticipoTxt.setText(Double.toString(ba.obtener(i).getRentasCobradasPorAnticipo()));
            InteresesAnticipadosTxt.setText(Double.toString(ba.obtener(i).getInteresesCobradosPorAnticipo()));
            totalPasivosNoCirculantesTxt.setText(Double.toString(ba.obtener(i).getTotalPasivosNoCirculantes()));
            totalPasivosTxt.setText(Double.toString(ba.obtener(i).getTotalPasivos()));
            capitalSocialTxt.setText(Double.toString(ba.obtener(i).getCapitalSocial()));
            aportacionesTxt.setText(Double.toString(ba.obtener(i).getAportacions()));
            primaVentasTxt.setText(Double.toString(ba.obtener(i).getPrimaVentaAcciones()));
            donacionesTxt.setText(Double.toString(ba.obtener(i).getDonaciones()));
            totalCapitalContribuido.setText(Double.toString(ba.obtener(i).getTotalCapitalContribuido()));
            utilidadTxt.setText(Double.toString(ba.obtener(i).getUtilidadDelEjercicio()));
            perdidaTxt.setText(Double.toString(ba.obtener(i).getPerdidaDelEjercicio()));
            utilidadesRetenidasTxt.setText(Double.toString(ba.obtener(i).getUtilidadesRetenidas()));
            totalCapitalGanadoTxt.setText(Double.toString(ba.obtener(i).getTotalCapitalGanado()));
            totalPatrimonioTxt.setText(Double.toString(ba.obtener(i).getTotalPatrimonio()));
            formulaTxt.setText(Double.toString(ba.obtener(i).getFormula()));
